...
const variants = {
    ...
    success: "border-transparent bg-green-500 text-zinc-50 hover:bg-green-500/80 dark:bg-green-900 dark:text-zinc-50 dark:hover:bg-green-900/80",
    warning: "border-transparent bg-yellow-500 text-zinc-50 hover:bg-yellow-500/80 dark:bg-yellow-900 dark:text-zinc-50 dark:hover:bg-yellow-900/80",
    info: "border-transparent bg-blue-500 text-zinc-50 hover:bg-blue-500/80 dark:bg-blue-900 dark:text-zinc-50 dark:hover:bg-blue-900/80",
}
