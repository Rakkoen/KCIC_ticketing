    ...
    return (
        <div className="hidden md:flex md:flex-shrink-0">
            <div className="flex flex-col w-64">
                ...
                <div className="flex flex-col h-full border-r border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800">
                    <div className="flex items-center justify-between flex-shrink-0 px-4 py-4 border-b border-zinc-200 dark:border-zinc-700">
                ...
                <div className="flex-shrink-0 flex border-t border-zinc-200 dark:border-zinc-700 p-4">
                    <div className="flex-shrink-0 w-full group block">
                        <div className="flex items-center">
                            <div>
                                <p className="text-sm font-medium text-zinc-700 dark:text-zinc-300 group-hover:text-zinc-900 dark:group-hover:text-white truncate">
                                    {user.email}
                                </p>
                                <button
                                    onClick={handleSignOut}
                                    className="text-xs font-medium text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-700 dark:group-hover:text-zinc-200 flex items-center mt-1 hover:text-red-600 dark:hover:text-red-400 transition-colors"
                                >
