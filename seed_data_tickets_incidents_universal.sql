-- Seed Data Universal untuk Tickets dan Incidents
-- File ini berisi query untuk mengisi tabel tickets dan incidents dengan data contoh
-- Data dapat diakses oleh semua user tanpa memperhatikan role

-- === TICKETS SAMPLE DATA ===
-- Data contoh untuk 10 tiket dengan berbagai status dan prioritas
-- Menggunakan user ID pertama yang ditemukan untuk created_by dan assigned_to

-- Ambil user ID pertama untuk digunakan sebagai contoh
DO $$
DECLARE
    sample_user_id UUID;
BEGIN
